...
Lastly, you'll need to install the EndSensorHolder on the side of the aluminum extrusion that the hot end is on. Slide it as far left as you can without the print head hitting the metal support that attaches to the extrusion. This is installed using a T nut.
